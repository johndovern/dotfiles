...
config.bind('.un', 'spawn --detach umpv {url} --x11-name=umpv')
config.bind('.uh', 'hint links spawn --detach umpv {hint-url} --x11-name=umpv')
config.bind('.ur', 'hint --rapid links spawn --detach umpv {hint-url} --x11-name=umpv')
...
config.bind('.dywh', 'hint links spawn --output-messages yt-dlp --config-location ~/.config/yt-dlp/yt-dlp-audio-for-webms.conf {hint-url}')
config.bind('.dywn', 'spawn --output-messages yt-dlp --config-location ~/.config/yt-dlp/yt-dlp-audio-for-webms.conf {url}')
config.bind('.dyvh', 'hint links spawn --output-messages yt-dlp --config-location ~/.config/yt-dlp/yt-dlp-video.conf {hint-url}')
config.bind('.dyvn', 'spawn --output-messages yt-dlp --config-location ~/.config/yt-dlp/yt-dlp-video.conf {url}')
config.bind('.dscn', 'spawn --output-messages yt-dlp --config-location ~/.config/yt-dlp/yt-dlp-audio-soundcloud.conf {url}')
config.bind('.dsch', 'hint links spawn --output-messages yt-dlp --config-location ~/.config/yt-dlp/yt-dlp-audio-soundcloud.conf {hint-url}')
